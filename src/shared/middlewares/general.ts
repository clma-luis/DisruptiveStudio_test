...
import { BAD_REQUEST_STATUS, INTERNAL_SERVER_ERROR_STATUS, UNAUTHORIZED_STATUS } from "../constants/statusHTTP";
...
export const validateToken = async (req: Request, res: Response, next: NextFunction) => {
  ...
  try {
    ...
    if (!user) {
      return res.status(UNAUTHORIZED_STATUS).json({ message: "Unauthorized - Invalid Token" });
    }
